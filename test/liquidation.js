...
describe("Question 3 Liquidation", function () {
  it("Case 8,128.956343 USDC", async function (num = "8128956343") {
  ...
  it("Case 8250 USDC", async function (num = "8250") {
    await network.provider.request({
      method: "hardhat_reset",
      params: [
        {
    ...
    const debt_USDC = ethers.utils.parseUnits(num, 6);
  ...
  it("Case 8,500 USDC", async function (num = "8500") {
    await network.provider.request({
      method: "hardhat_reset",
      params: [
        {
  ...
  it("Case 8,750 USDC", async function (num = "8750") {
    await network.provider.request({
      method: "hardhat_reset",
      params: [
        {
  ...
  it("Case 9,000 USDC", async function (num = "9000") {
    await network.provider.request({
      method: "hardhat_reset",
      params: [
        {
  ...
  it("Case 9,250 USDC", async function (num = "9250") {
    await network.provider.request({
      method: "hardhat_reset",
      params: [
        {
  ...
  it("Case 9,500 USDC", async function (num = "9500") {
    await network.provider.request({
      method: "hardhat_reset",
      params: [
        {
