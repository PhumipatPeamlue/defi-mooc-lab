...
Phumipat Peamlue (ภูมิภัทร เปี่ยมลือ) 6310505751

## Branch Detail

- main -> templete
- question2 -> โค้ดของ contract และ test ที่ใช้ทำ liquidation ข้อ 2
- question3 -> โค้ดของ contract และ test ที่ใช้ทำ liquidation ข้อ 3
