...
describe("Question 2 Liquidation", function () {
  it("Case 2,000 USDT", async function (num = "2000") {
    ...
    const debt_USDT = ethers.utils.parseUnits(num, 6);
  ...
  it("Case 5,000 USDT", async function (num = "5000") {
    await network.provider.request({
      method: "hardhat_reset",
      params: [
        {
  ...
  it("Case 10,000 USDT", async function (num = "10000") {
    await network.provider.request({
      method: "hardhat_reset",
      params: [
        {
